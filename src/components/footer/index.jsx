    ...
    <footer className="footer-container">
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-socials">
          {/* X (Twitter) */}
          <a href="#" className="social-icon" title="X" aria-label="X">
            <svg
