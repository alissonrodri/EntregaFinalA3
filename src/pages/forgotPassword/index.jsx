      ...
      <div className="signin-form">
        {step === 1 && (
          <form onSubmit={handleVerifyEmail}>
            <h2>
              Recuperar <span className="logo-text">Senha</span>
            </h2>
            <p
              style={{
                textAlign: "center",
        ...
        {step === 2 && (
          <form onSubmit={handleVerifyCode}>
            <h2>
              Código de <span className="logo-text">Verificação</span>
            </h2>
            <p
              style={{
                textAlign: "center",
        ...
        {step === 3 && (
          <form onSubmit={handleResetPassword}>
            <h2>
              Redefinir <span className="logo-text">Senha</span>
            </h2>
            <p
              style={{
                textAlign: "center",
            ...
            <div className="form-group">
              ...
              <div className="password-input-wrapper">
                ...
                >
                  <img
                    src={showNovaSenha ? iconShow : iconHidden}
                    alt="Alternar"
            ...
            <div className="form-group">
              ...
              <div className="password-input-wrapper">
                ...
                >
                  <img
                    src={showConfirmarSenha ? iconShow : iconHidden}
                    alt="Alternar"
                    className="password-icon"
                  />
                </button>
          ...
          <div style={{ textAlign: "center" }}>
            <h2>
              ...
              <span
                ...
                style={{ color: "var(--contrast)", verticalAlign: "middle" }}
              >
                celebration
              </span>
            </h2>
            <p style={{ marginTop: "20px", color: "var(--text-muted)" }}>
              ...
              sistema com as novas credenciais.
            </p>
            <button
