          ...
          {jogos.length === 0 ? (
            ...
            jogos.map((item, i) => (
              <div key={i} className="hist-item">
                <div className="hist-item-icon"><span className="material-symbols-outlined">sports_esports</span></div>
    ...
    <main className="hist-container">
      ...
      {vendas.length === 0 ? (
        <div className="hist-empty">
          <span className="hist-empty-icon"><span className="material-symbols-outlined">receipt_long</span></span>
